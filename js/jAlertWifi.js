...
// Data: 04/22/2021
// Dependências: jQuery library, jPanelWifi.css
...
// - $hasTimer: 
//   * true (apresenta um contador regressivo no painel ao invés da combinação "mensagem + btn")
...
// Exemplos:
//  showPanelInfo("",true,3,"","100"): exibe o painel de informações com o texto inicialmente em 3 até chegar 0 e depois o painel desaparece
...
function alertWifi($txt, $hasTimer, $countTimer, $srcImg, $fontSize) {
    ...
    // Se não houver timer exibe um texto fixo ao invés de um cronometro regressivo
    if (!$hasTimer) {
